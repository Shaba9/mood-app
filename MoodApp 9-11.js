...
btn.onclick = function () {
    if (btn.id == "start"){
        ...
        back.id = "back";
        goBack();
        document.getElementById("main").insertBefore(back, btn);
		...
		document.getElementById("question").innerHTML = message1 + emoji + message2;
...
// Make it mobil.
// Beautify options.
// Shift buttons upwards on final page.
